...
<div class="row my-3">
    ...
    <form method="POST">
        ...
        <div class="form-group">
            <input type="text" onfocus="this.type='Date'" name="starting_date" placeholder="Staring Date" class="form-control" required/>
        ...
        <input type="submit" value="Add Election" name="addElectionBtn" class="btn btn-dark" />
    </form>
</div>
    <div class="col-8">
        ...
        ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-sm btn-danger" onclick="DeleteData(<?php echo $election_id = $row['id']; ?>)"> Delete </button>
            ...
            ?>
                <tr>
                    <td colspan="7"> No Election have been added yet.</td>
                </tr>
            <?php
            }
        ...
        ?>
            ...
            <script>
                const DeleteData = (e_id) =>
                {
                    ...
                    if(c == true)
                {
                    location.assign("index.php?addElectionPage=1&added=1&delete_id="+ e_id);
                }
                }
            </script>
...
<?php
    if(isset($_POST['addElectionBtn']))
    {
        ...
        mysqli_query($db, "INSERT INTO elections (election_topic, no_of_candidates, starting_date, ending_date, status, inserted_by, inserted_on) VALUES('".$election_topic."', '".$number_of_candidates."', '".$starting_date."', '".$ending_date."', '".$status."', '".$inserted_by."', '".$inserted_on."')") or
        die(mysqli_error($db));
        }
        ?>
